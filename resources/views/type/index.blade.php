                ...
                <div class="flex-row  px-5 py-4 bg-white rounded shadow">
                    ...
                    <div class="mt-5 bg-white rounded">
                        ...
                        <div class="py-5 px-4 border-b">
                            <form action="{{ route('type.all') }}" method="get" class="w-full">
                                <div>
